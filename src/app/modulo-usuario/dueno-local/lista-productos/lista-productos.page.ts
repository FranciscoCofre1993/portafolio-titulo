...
import { ConfDeleteProductoDialogComponent } from '../../../modulo-admin/Productos/components/conf-delete-producto-dialog/conf-delete-producto-dialog.component'
...
export class ListaProductosPage implements OnInit {
  ...
  detalle(item:any){
    const navigationExtras: NavigationExtras = {
      state: {
        item: item,
        paginaAnterior:'/tabs/dueno-local/lista-productos'
      }
    };
    this.eventos.RecargarProductos.emit(true);
    this.router.navigate(['/tabs/dueno-local/modificar-producto'], navigationExtras);
  }
  ...
  goAgregarProducto() {
    ...
    this.router.navigate(['/tabs/dueno-local/agregar-producto'], navigationExtras);
  }
