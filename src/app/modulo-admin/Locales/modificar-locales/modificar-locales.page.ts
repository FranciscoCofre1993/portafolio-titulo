...
@Component({
  selector: 'app-modificar-locales',
  templateUrl: './modificar-locales.page.html',
  styleUrls: ['./modificar-locales.page.scss'],
})
export class ModificarLocalesPage implements OnInit {
  local: any;
